 ...
 */
static int type_case(data_t *data1, data_t *data2, type_sort_t *sort_order,
                     int i) {
 ...
 * @return Résultat de la comparaison
 */
static int name_case(data_t *data1, data_t *data2, type_sort_t *sort_order,
                     int i) {
 ...
 * @return Résultat de la comparaison
 */
static int id_case(data_t *data1, data_t *data2, type_sort_t *sort_order,
                   int i) {
 ...
 * @return Résultat de la comparaison
 */
static int switch_case(data_t *data1, data_t *data2, type_sort_t *sort_order,
                       int i) {
  switch (sort_order[i]) {
  case TYPE:
  case TYPE_R:
 ...
 * @param sort_order Ordre de tri
 */
static void sort_f_aux(linked_list_t **min, linked_list_t *tmp_2,
                       type_sort_t *sort_order) {
